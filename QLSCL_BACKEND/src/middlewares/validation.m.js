...
// 2. Bộ luật cho API Đăng nhập (Hỗ trợ cả Email và Username)
const loginSchema = Joi.object({
    identifier: Joi.string().required().messages({
        'string.empty': 'Vui lòng nhập Email hoặc Tên đăng nhập!',
        'any.required': 'Vui lòng nhập Email hoặc Tên đăng nhập!'
    }),
    email: Joi.string().email().optional(), // Giữ lại để tương thích ngược nếu cần

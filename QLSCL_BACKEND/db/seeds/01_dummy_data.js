...
exports.seed = async function(knex) {
  ...
  console.log('🌱 Đang nạp dữ liệu mẫu cho hệ thống...');
  ...
  // 3. Chèn dữ liệu Cơ sở (Locations)
  ...
  // 4. Chèn dữ liệu Sân cầu lông (Courts)
  await knex('Courts').insert([
    ...
    { id: 4, name: 'Sân Đơn Q7', type: 'Single', location_id: 2, price_per_hour: 60000, status: 'Active' }
  ]);

  // Cập nhật Sequence cho Postgres
